import { Man, PlaceRounded, StarRateRounded } from '@mui/icons-material'
import { Avatar, Button, Divider, Grid, LinearProgress, Typography } from '@mui/material'
        ...
        <Grid spacing={3} container>
                ...
                <Grid lg={8} item>
                    <Box>
                        <Box sx={{border: "1px solid #e0e0e0", borderRadius: "4px", backgroundColor: "#fff"}}>
                            <Box sx={{padding: "1.4rem"}}>
                                <Typography variant='h6' fontWeight={600}>Web Developer</Typography>
                                <br/>
                                <Stack spacing={2}>
                    ...
                    <Box>
                        <Box sx={{border: "1px solid #e0e0e0", borderRadius: "4px", backgroundColor: "#fff"}}>
                            <Box sx={{padding: "1.4rem"}}>
                                <Stack spacing={2}>
                                    <Typography fontWeight={600} sx={{flexGrow: 1}}>Education</Typography>
                                    <Stack spacing={1}>
                                      <Stack direction="row" spacing={1}>
                                        <Typography variant='body2'>B.A</Typography>
                                        <Typography variant='body2' color="gray">Computer Science</Typography>
                                      </Stack>
                                      <Typography variant='body2'>Kandahar, Afghanistan, Kandahar University</Typography>
                                    </Stack>
                                ...
                                <Stack spacing={2}>
                                    ...
                                    <Stack direction="row" spacing={1}>
                                        <Typography variant='body2' fontWeight={600}>UI Design Award</Typography>
                                        <Typography variant='body2' color="gray">2018</Typography>
                                    </Stack>
                                </Stack>
                            </Box>
                        </Box>
